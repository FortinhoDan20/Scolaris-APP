  ...
  isActive
    ...
    : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
              ...
              >
                ...
                {isActive && (
                  <span
                    className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-3 h-1 rounded-sm bg-indigo-600"
                    aria-hidden
                  />
                )}
              </button>
        ...
        <div className="mt-6">
          <div
            ...
            className={`transition-opacity duration-200 ${
              active === "cycle" ? "opacity-100" : "opacity-0"
            }`}
          >
            <h3 className="text-lg font-semibold">Cycle organisé</h3>
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
              Contenu lié au cycle organisé. Place ici les champs ou les
              tableaux que tu veux (ex : nom du cycle, durée, dates...).
            </p>
          </div>
          ...
          <div
            ...
            className={`transition-opacity duration-200 ${
              active === "option" ? "opacity-100" : "opacity-0"
            }`}
          >
            <h3 className="text-lg font-semibold">Option</h3>
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
              Ici tu peux lister ou gérer les options (ex : filières, modules,
              spécialités).
            </p>
          </div>
          ...
          <div
            ...
            hidden={active !== "salle"}
            className={`transition-opacity duration-200 ${
              active === "salle" ? "opacity-100" : "opacity-0"
            }`}
          >
            <h3 className="text-lg font-semibold">Salle de classe</h3>
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
              Gestion des salles: numéro, capacité, équipements, etc.
            </p>
          </div>
          ...
          <div
            ...
            className={`transition-opacity duration-200 ${
              active === "eleves" ? "opacity-100" : "opacity-0"
            }`}
          >
            <h3 className="text-lg font-semibold">Éleves</h3>
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
              Liste des élèves ou résumé (nombre total, par option, par
              cycle...).
            </p>
          </div>
        </div>
